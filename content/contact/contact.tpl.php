...
<div class="content">
    <div class="floater">
        <h1><?= $this->data['l11n']['Contact']; ?></h1>

        <ul>
            <li>Email: <a href="mailto:info@jingga.app">info@jingga.app</a>
            ...
            <li>Twitter: <a href="https://twitter.com/jinggaApp">https://twitter.com/jinggaApp</a>
